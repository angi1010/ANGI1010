# How to create a website using Hugo Framwork and host it on GitHub


Step-by-step easy to follow up tutorial to build websites using **Hugo** and host it on **Github**.
